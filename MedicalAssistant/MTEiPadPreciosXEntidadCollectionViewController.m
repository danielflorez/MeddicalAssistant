//
//  MTEiPadPreciosXEntidadCollectionViewController.m
//  MedicalAssistant
//
...
#import "MTEiPadPreciosXEntidadCollectionViewController.h"
#import "MTEMedicalCenter.h"
#import "MTEiPadPrecioXEntidadCollectionViewCell.h"

@interface MTEiPadPreciosXEntidadCollectionViewController ()
...
@implementation MTEiPadPreciosXEntidadCollectionViewController
...
{
    [super viewDidLoad];
    [self.collectionView registerNib:[UINib nibWithNibName:@"MTEiPadPrecioXEntidadCollectionViewCell" bundle:nil]
...
- (MTEiPadPrecioXEntidadCollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    MTEiPadPrecioXEntidadCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"precioEntCell" forIndexPath:indexPath];
...
-(void)grabar
{
    ...
    for (int i=0;i < [self.entidades count];i++)
    {
        ...
        MTEiPadPrecioXEntidadCollectionViewCell *cell = (MTEiPadPrecioXEntidadCollectionViewCell *)[self.collectionView
