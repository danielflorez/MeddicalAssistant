//
//  MTEiPadCrearClienteViewController.m
//  MedicalAssistant
//
...
#import "MTEiPadSelecEntidadTableViewController.h"
#import "MTEMedicalCenter.h"

@interface MTEiPadCrearClienteViewController ()
...
@property (nonatomic, strong) MTEiPadSelecEntidadTableViewController *sevc;
@property (nonatomic, strong) UIActivityIndicatorView *spinner;
@property (nonatomic, strong) NSMutableData *dataRecieved;
@end

@implementation MTEiPadCrearClienteViewController
...
- (IBAction)selecEntidadClick:(id)sender
{
    if (!self.sevc)
    {
        self.sevc = [[MTEiPadSelecEntidadTableViewController alloc] initWithStyle:UITableViewStyleGrouped];
    }
    self.sevc.ccvc = self;
