//
//  MTEiPadCrearProcedimientoViewController.m
//  MedicalAssistant
//
...
@interface MTEiPadCrearProcedimientoViewController ()
...
@implementation MTEiPadCrearProcedimientoViewController
...
- (IBAction)preciosClick:(id)sender
{
    ...
    MTEiPadPreciosXEntidadCollectionViewController *ccvc = [storyboard instantiateViewControllerWithIdentifier:@"iPadPreciosXEntidad"];
    ccvc.proc = self.proc;
