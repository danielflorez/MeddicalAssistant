//
//  MTECrearConsultorioViewController.m
//  MedicalAssistant
//
...
@interface MTECrearConsultorioViewController ()
...
@implementation MTECrearConsultorioViewController
...
{
    if (self.crear == 0) {
        self.descripcionText.text = self.consultorio.descr;
...
- (IBAction)crearClick:(id)sender {
    ...
    NSString *descr = self.descripcionText.text;
...
-(void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    {
        if (self.crear == 1) {
            [[MTEMedicalCenter sharedCenter] loadConsultorios:self.ctvc];
