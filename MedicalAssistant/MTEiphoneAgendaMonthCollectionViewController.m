//
//  MTEiphoneAgendaMonthCollectionViewController.m
//  MedicalAssistant
//
...
@interface MTEiphoneAgendaMonthCollectionViewController ()
...
@implementation MTEiphoneAgendaMonthCollectionViewController
...
- (IBAction)myClickEvent:(id)sender event:(id)event
{
    ...
    MTEday *d = [self.days objectAtIndex:indexPath.row];
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main_iPhone" bundle:nil];
    MTEAgendaDayTableViewController *adtc = [storyboard instantiateViewControllerWithIdentifier:@"dayAgenda"];
    adtc.day = d;
    adtc.consul = self.consul;
    adtc.memberID = self.memberID;
    adtc.iamvc =self;
    adtc.citas = self.citas;
    [self.navigationController pushViewController:adtc
                                         animated:YES];
                                 ...
                                 atIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (kind == UICollectionElementKindSectionHeader) {
        MTEagendaCollectionHeader *headerView = [collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:@"agendaHeader" forIndexPath:indexPath];
