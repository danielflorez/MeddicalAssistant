//
//  MTEiPadRegisterViewController.m
//  MedicalAssistant
//
...
@interface MTEiPadRegisterViewController ()
...
@implementation MTEiPadRegisterViewController
...
- (void)viewDidLoad
{
    ...
    UIView *paddingView2 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 49, 65)];
    UIView *paddingView3 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 49, 65)];
    UIView *paddingView4 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 49, 65)];
    UIView *paddingView5 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 49, 65)];
    UIView *paddingView6 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 49, 65)];
    UIView *paddingView7 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 49, 65)];
    self.nameTextField.leftView = paddingView;
    self.nameTextField.leftViewMode = UITextFieldViewModeAlways;
    self.lastNameTextField.leftView = paddingView1;
    self.lastNameTextField.leftViewMode = UITextFieldViewModeAlways;
    self.cedulaTextField.leftView = paddingView2;
    self.cedulaTextField.leftViewMode = UITextFieldViewModeAlways;
    self.phoneTextField.leftView = paddingView3;
    ...
    self.passwordTextField.leftView = paddingView6;
    self.passwordTextField.leftViewMode = UITextFieldViewModeAlways;
    self.confirmPasswordTextField.leftView = paddingView7;
