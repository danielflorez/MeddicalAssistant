//
//  MTEiPadClientesTableViewController.m
//  MedicalAssistant
//
...
#import "MTEiPadPacienteTableViewCell.h"
...
@interface MTEiPadClientesTableViewController ()
@property (weak, nonatomic) IBOutlet UISearchBar *clientesSearchBar;

@end

@implementation MTEiPadClientesTableViewController
...
- (void) addPaciente
{
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Main_iPad"
                                                         bundle:nil];
    MTEiPadCrearClienteViewController *ccvc = [storyboard instantiateViewControllerWithIdentifier:@"iPadCrearCliente"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MTEiPadPacienteTableViewCell *cell = (MTEiPadPacienteTableViewCell *) [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    if (cell == nil) {
        ...
        for (id currentObject in topLevelObjects){
            if ([currentObject isKindOfClass:[UITableViewCell class]]){
                cell =  (MTEiPadPacienteTableViewCell *) currentObject;
                break;
            }
        }
    }
